...
| keyword        | usage               | image
|:--------------:|:-------------------:|
| `title`        | Title               | ![parts_usecase](/draw_uml/assets/img/diagrams/parts/title.png)
| `note left :`  | Notes Left          | ![parts_usecase](/draw_uml/assets/img/diagrams/parts/note_left.png)
| `note right :` | Notes Right         | ![parts_usecase](/draw_uml/assets/img/diagrams/parts/note_right.png)
| `' `           | Single-line Comment |
| `/' '/`        | Block Comment       |
...
| keyword    | usage    | image
|:----------:|:--------:|
| `actor`    | Actor    | ![parts_usecase](/draw_uml/assets/img/diagrams/element/actor.png)
| `boundary` | Boundary | ![parts_usecase](/draw_uml/assets/img/diagrams/element/boundary.png)
| `control`  | Control  | ![parts_usecase](/draw_uml/assets/img/diagrams/element/control.png)
| `entity`   | Entity   | ![parts_usecase](/draw_uml/assets/img/diagrams/element/entity.png)
...
![basic_participant](/draw_uml/assets/img/diagrams/basic/participant.png)
